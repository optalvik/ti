...
```mermaid
flowchart LR
    subgraph Põhimõisted
        A[01 Sissejuhatus] --> B[02 Masinõpe] --> C[03 LLM-id]
    end

    subgraph Praktilised oskused
        C --> D[04 Prompting] --> E[05 Tööriistad] --> F[06 Koodi gen.] --> G[07 Agendid]
    end

    subgraph Taust ja tulevik
        G --> H[08 Algoritmid] --> I[09 Eetika] --> J[10 Trendid]
    end
```
